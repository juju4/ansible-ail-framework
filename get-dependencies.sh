...
#[ ! -e $rolesdir/juju4.ail_framework ] && ln -s ansible-ail-framework $rolesdir/juju4.ail_framework
[ ! -e $rolesdir/juju4.ail_framework ] && cp -R $rolesdir/ansible-ail-framework $rolesdir/juju4.ail_framework
